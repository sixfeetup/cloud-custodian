...
def test_ec2_compute_optimizer_server_side_valid(test):
    session_factory = test.replay_flight_data("test_ec2_compute_optimizer_server_side_filters")
    test.load_policy(
        {
...
def test_ec2_compute_optimizer_server_side_invalid(test):
    session_factory = test.replay_flight_data(
        "test_ec2_compute_optimizer_server_side_recommendation_preferences"
    )
