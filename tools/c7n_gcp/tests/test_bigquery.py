...
class BigQueryTableTest(BaseTest):
    ...
    def test_table_recommend_partition_cluster_permissions(self):
        ...
        baseline_policy = self.load_policy(
            {
        ...
        self.assertEqual(len(baseline_resources), 1)
        self.assertEqual('c7n:recommend' in baseline_resources[0], False)
        ...
        self.assertEqual(policy.get_permissions(), {
        ...
        self.assertEqual(len(resources), 1)
        self.assertEqual('c7n:recommend' in resources[0], True)
        self.assertEqual(len(resources[0]['c7n:recommend']) >= 1, True)
        self.assertEqual(resources[0]['tableReference'], baseline_resources[0]['tableReference'])
        recommendation = resources[0]['c7n:recommend'][0]
        self.assertEqual(bool(recommendation['name']), True)
        self.assertEqual(bool(recommendation['recommenderSubtype']), True)
        self.assertEqual(
